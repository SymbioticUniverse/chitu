  ...
  switch (paradigm) {
    ...
    case "constraint":
      return [
        ...
        "2. **If there are multiple valid approaches, you MUST use `ask_user` to let the user choose.** Do NOT pick one yourself.",
        "3. Describe your plan in 1-2 sentences and wait for the user to confirm before proceeding.",
        "4. Call `horsewhip_lock_intent` to declare which files you need to modify. One use per iteration.",
        "5. Implement the changes inside the boundary. New files are always allowed.",
        "6. When done, call `complete_sub_goal` with your exports, imports, and capability.",
        "",
        "**Constraints:**",
