...
export const CONSTRAINT_INSTRUCTION = [
  ...
  "",
  "7. **Self-review (MANDATORY before complete_sub_goal)**: Do NOT skip this step — Gate 4 will block you if review is missing.",
  ...
  "   - Write the review to `.chitu/plans/current/review.md`. Be specific — mention file names and concerns. Must be at least 50 characters.",
