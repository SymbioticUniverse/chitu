...
export const CONSTRAINT_INSTRUCTION = [
  ...
  "",
  "7. **Complete**: Call `complete_sub_goal` with this iteration's exports and imports. This is MANDATORY — it triggers git commit. Skipping it means your work is lost.",
  "",
