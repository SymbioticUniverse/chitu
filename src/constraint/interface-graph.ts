...
export const CONSTRAINT_INSTRUCTION = [
  ...
  "",
  "**The user comes first.** Before locking any files:",
  ...
  "- If there are multiple approaches, use `ask_user` to let the user choose",
  "- Describe your understanding and plan; wait for confirmation",
  "- **Do NOT call `horsewhip_lock_intent` until the user confirms your plan**",
  "",
